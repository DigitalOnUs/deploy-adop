...
CMD=`basename $0`
required_params='AWS_ACCESS_KEY_ID AWS_ACCESS_SECRET_KEY AWS_DEFAULT_REGION AWS_INSTANCE_TYPE AWS_VPC_ID AWS_SPOT_PRICE AWS_INSTANCE_NAME ADOP_DIR ADOP_USER ADOP_PWD ADOP_COMMIT'
